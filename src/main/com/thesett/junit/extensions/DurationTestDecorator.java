 ...
 *         TKTestResult when the duration is up, so that it can terminate any repeats in progress. It should end as soon
 *         as possible once the test method exits.
 */
public class DurationTestDecorator extends WrappedSuiteTestDecorator implements ShutdownHookable
{
     ...
     *
     * <p/>The test loop implemented by DurationTestDecorator checks that the duration has not expired, on each test
