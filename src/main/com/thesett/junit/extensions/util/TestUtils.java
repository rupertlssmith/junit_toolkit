...
{
    /**
     * Injects a short pause. The pause may not complete its full length, if the thread is interrupted when waiting. In
     * most cases, this will not happen and this method is a vry adequate pause implementation, without the need to
