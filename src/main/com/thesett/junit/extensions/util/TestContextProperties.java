...
/**
 * TestContextProperties is an extension of {@link ParsedProperties} that keeps track of property key/value pairs that
 * are used by tests being run under the {@link com.thesett.junit.extensions.TKTestRunner}. To keep the test runner
 * notified of configurable test parameters, tests should establish their required property values by initiliazing
 * fields or statics or in the constructor, through this class. The tk test runner automatically places any additional
 * properties specified on the command line into the this class, and these are held statically.
 *
 ...
 * </pre>
 *
 * <p/>This has the effect of setting up the field testParam with the default value of 1, unless it is overridden by
 * values passed to the tk test runner. It also notifies the tk test runner of the name and value of the test parameter
 * actually used for the test, so that this can be logged in the test output file.
 *
...
public class TestContextProperties extends ParsedProperties
{
    ...
    /**
     * Gets the singleton instance of the test context properties, applying a specified set of default properties to it,
     ...
     * available to {@link com.thesett.junit.extensions.TKTestRunner}.
     *
     ...
     * method. Enforces use of strings for property keys and values. The value returned is the result of the <tt>
     * Hashtable</tt> call to <code>put</code>. The property key/value pair is remembered and made available to
     * {@link com.thesett.junit.extensions.TKTestRunner}.
     *
     ...
     * remembered and made available to {@link com.thesett.junit.extensions.TKTestRunner}.
     *
     * @param  key   The name of the system property to set.
     * @param  value The value to set it to.
     *
     * @return The value of the property, which will be the value passed in if it was null, or the existing value
     *         otherwise.
     */
